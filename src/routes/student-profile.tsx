...
function StudentProfileScreen() {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[430px] flex-col bg-white pb-[max(6rem,env(safe-area-inset-bottom)+1.5rem)] pt-[max(1rem,env(safe-area-inset-top))]">
      {/* Top Bar */}
